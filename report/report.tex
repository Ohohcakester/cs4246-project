...
\begin{figure}[!h]
  \centering
    \includegraphics[width=280px,natwidth=665,natheight=501]{selected_GP/3056.csv_X.png}
...
In our experiment, we do a simplified version of our model, using independent Gaussian Process models for each of the axes $x$, $y$ and $z$, thus assuming the covariances between any two variables to be $0$. \\
...
\begin{figure}[h!]
  \centering
    \includegraphics[width=280px,natwidth=665,natheight=505]{selected_GP/3064.csv_Y.png}
...
At each of the chosen time points, the number of unique tags within each of the $112$ regions is counted. This is the actual data to be compared against. A small fraction (about $10\%$) of the people is then taken, and the Gaussian Process model above is used to estimate the number of people within each of the regions.
