...
instead of direct comparing between methods, state that GP fits to our application that we can just provide any regions and we are able to predict the output
curve fitting methods, does not give us variances, so we cannot integrate over regions
