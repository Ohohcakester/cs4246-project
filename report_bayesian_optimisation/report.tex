...
\begin{figure}[h!]
  \centering
    \includegraphics[width=120px]{diagrams/26-27_86-83_59-49_1216532755_predicted.png}
  \caption{Crowd density distribution through regression over $x,y,z$ coordinates.}
  \label{fig:t4dist}
\end{figure}
